...
address or hostname, and optional `:port`, by which $HOST2 can reach
it). NB: if there is a firewall between $HOST1 and $HOST2, you must
open port 6783 for TCP and UDP.
