...
with the weave on $HOST1 (specified as the IP address or hostname by
which $HOST2 can reach it). NB: if there is a firewall between $HOST1
and $HOST2, you must open port 6783 for TCP and UDP.
