...
func TestBootstrap(t *testing.T) {
	...
	alloc1.OnGossipBroadcast(alloc2.ourName, alloc2.Gossip())
	...
	alloc2.OnGossipBroadcast(alloc1.ourName, alloc1.Gossip())
...
func TestGossipSkew(t *testing.T) {
	...
	if err := alloc1.OnGossipBroadcast(alloc2.ourName, alloc2.Gossip()); err == nil {
		t.Fail()
	}
}
