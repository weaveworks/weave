...
func cniNet(args []string) error {
	...
	cni.PluginMain(n.CmdAdd, n.CmdCheck, n.CmdDel, version.All, bv.BuildString("weave"))
	return nil
}
...
func cniIPAM(args []string) error {
	...
	cni.PluginMain(i.CmdAdd, i.CmdCheck, i.CmdDel, version.All, bv.BuildString("weave"))
	return nil
}
