 ...
 * [Weave Net monitoring setup using kube-prometheus](https://github.com/weaveworks/weave/blob/master/site/tasks/manage/metrics.md#weave-net-monitoring-setup-using-kube-prometheus)
