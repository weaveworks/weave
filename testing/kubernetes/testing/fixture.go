// Modified from the original at k8s.io/client-go/testing in line with
// https://github.com/kubernetes/kubernetes/pull/68460
/*
...
func (t *tracker) add(gvr schema.GroupVersionResource, obj runtime.Object, ns string, replaceExisting bool) error {
	...
	newMeta.SetResourceVersion(fmt.Sprintf("%d", t.counter))
	t.counter++
