...
Kubernetes using [Kubernetes Addon]({{ '/kubernetes/kube-addon' | relative_url }}) then you can set CONN_LIMIT environment variable to set
the connection limit.

**See Also**

 * [Weave Net Router Encapsulation]({{ '/concepts/router-encapsulation' | relative_url }})
