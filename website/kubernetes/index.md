...
> [Kubernetes Addon]({{ '/kubernetes/kube-addon' | relative_url }}). The instructions below
...
See [Creating Peer Connections Between Hosts]({{ '/install/using-weave#peer-connections' | relative_url }}) 
