...
discovery is
[enabled by default]({{ '/tasks/manage/finding-adding-hosts-dynamically' | relative_url }}).
...
[IPAM]({{ '/tasks/ipam/ipam' | relative_url }}) is the subsystem responsible for dividing up a
...
* [Uniform Dynamic Cluster]({{ '/operational-guide/uniform-dynamic-cluster' | relative_url }})
...
* [Interactive Deployment]({{ '/operational-guide/interactive' | relative_url }})
* [Uniform Fixed Cluster]({{ '/operational-guide/uniform-fixed-cluster' | relative_url }})
...
* [Autoscaling]({{ '/operational-guide/autoscaling' | relative_url }})
...
[destroyed explicitly]({{ '/operational-guide/tasks#reset' | relative_url }})
if necessary.
